...
public class SecurityConfig {
    ...
    @Value("${cors.allowed-origins:http://localhost:3000,http://localhost:8081,http://localhost:5173}")
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/courts/**", "/api/centers/**", "/api/incidents/**").permitAll()
